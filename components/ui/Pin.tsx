...
export const PinPerspective = ({
  ...
  return (
    <motion.a
      href={href}
      target={"_blank"}
      className="pointer-events-none w-full h-80 flex items-center justify-center opacity-0 z-[60] transition duration-500"
    >
      <div className="w-full h-full -mt-7 flex-none inset-0">
        ...
        {/* <>
          <motion.div className="absolute right-1/2 bottom-1/2 bg-gradient-to-b from-transparent to-cyan-500 translate-y-[14px] w-px h-20 blur-[2px]" />
          <motion.div className="absolute right-1/2 bottom-1/2 bg-gradient-to-b from-transparent to-cyan-500 translate-y-[14px] w-px h-20" />
